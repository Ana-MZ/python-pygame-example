...
def create_pipe():
	...
	bottom_pipe = pipe_surface.get_rect(midtop = (WIDTH + 150, random_pipe_pos))
	top_pipe = pipe_surface.get_rect(midbottom = (WIDTH + 150, random_pipe_pos - 300))
...
#bird_surface = pygame.image.load(os.path.join("assets", "bluebird-midflap.png")).convert_alpha()
#bird_surface = pygame.transform.scale2x(bird_surface)
#bird_rect = bird_surface.get_rect(center = (100, HEIGHT/2))

pipe_surface = pygame.image.load(os.path.join("assets", "pipe-green.png"))
